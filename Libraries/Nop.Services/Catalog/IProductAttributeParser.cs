...
namespace Nop.Services.Catalog
{
    ...
    public partial interface IProductAttributeParser
    {
        ...
        string CustomParseProductAttributes(Product product, IFormCollection form, List<string> errors, string colourSqureId);

        int CustomParseEnteredQuantity(Product product, IFormCollection form, string colourSqureId);
        //  string CustomGetProductAttributesXml(Product product, IFormCollection form, List<string> errors, string colourSqureId);
        // custom code end
    }
}
