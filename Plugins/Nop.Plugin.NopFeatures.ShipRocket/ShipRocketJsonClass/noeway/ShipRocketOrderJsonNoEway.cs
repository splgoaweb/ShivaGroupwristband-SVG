...
namespace Nop.Plugin.NopFeatures.ShipRocket.ShipRocketJsonClass.noeway
{
    public partial class ShipRocketOrderJsonNoEway : BaseNopModel
    {
        public ShipRocketOrderJsonNoEway()
        {
            order_items = new List<ShipRocketOrderItems>();
        }
        ...
        public IList<ShipRocketOrderItems> order_items { get; set; }
